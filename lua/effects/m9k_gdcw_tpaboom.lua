...
local vCached2 = Vector(0,0,-50)
local vCached3 = Vector(0,0,-60)
...
function EFFECT:obj_Particle()
	...
	for i = 1,30 * self.Scale do
		...
		local obj_Particle = self.eParticleEmitter:Add("effects/fire_cloud1",self.Pos)

		if obj_Particle then
			obj_Particle:SetVelocity(self.DirVec * mathrandom(100,400) * self.Scale + ((VectorRand():GetNormalized() * 400) * self.Scale))
			obj_Particle:SetDieTime(mathRand(0.5,2) * self.Scale)
			obj_Particle:SetStartAlpha(100)
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetStartSize(50 * self.Scale)
			obj_Particle:SetEndSize(100 * self.Scale)
			obj_Particle:SetRoll(mathRand(150,360))
	...
	for i = 1,self.Debris do
		...
		local RanVec = self.DirVec * mathRand(0.5,3) + (DustRing * mathRand(3,7))
		...
		for k = 3,self.Particles do
			...
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetGravity((VectorRand():GetNormalized() * mathRand(5,10) * self.Size) + vCached2)
			...
			obj_Particle:SetColor(110 + Rcolor,107 + Rcolor,100 + Rcolor)
		end
		...
		for k = 3,self.Particles do
			...
			obj_Particle:SetVelocity((VectorRand():GetNormalized() * mathRand(1,2) * self.Size) + (RanVec * self.Size * k * 3.5) + (VectorRand() * 100))
			obj_Particle:SetDieTime(mathRand(0.5,3) * self.Scale)
			obj_Particle:SetStartAlpha(mathRand(120,150))
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetGravity((VectorRand():GetNormalized() * mathRand(5,10) * self.Size) + vCached2)
			obj_Particle:SetAirResistance(200 + self.Scale * 20)
			obj_Particle:SetStartSize(5)
			obj_Particle:SetEndSize(10)
			obj_Particle:SetRoll(mathrandom(-500,500) / 100)
			obj_Particle:SetRollDelta(mathrandom(-1.5,1.5))
			obj_Particle:SetColor(255,255,255)
		end
	end
end
...
function EFFECT:Dirt()
	...
	for i = 1,self.Debris do
		...
		local RanVec = self.DirVec * mathRand(0.5,4) + (DustRing * mathRand(3,7))
		...
		for k = 3,self.Particles do
			...
			obj_Particle:SetVelocity((VectorRand():GetNormalized() * mathRand(1,2) * self.Size) + (RanVec * self.Size * k * 3.5))
			obj_Particle:SetDieTime(mathRand(0.5,4) * self.Scale)
			obj_Particle:SetStartAlpha(mathRand(110,130))
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetGravity((VectorRand():GetNormalized() * mathRand(5,10) * self.Size) + vCached2)
			obj_Particle:SetAirResistance(200 + self.Scale * 20)
			obj_Particle:SetStartSize((5 * self.Size) - ((k / self.Particles) * self.Size * 3))
...
function EFFECT:Sand()
	...
	for i = 1,30 * self.Scale do
		...
		if obj_Particle then
			obj_Particle:SetVelocity(self.DirVec * mathrandom(100,400) * self.Scale + ((VectorRand():GetNormalized() * 400) * self.Scale))
			obj_Particle:SetDieTime(mathRand(0.3,3) * self.Scale)
			obj_Particle:SetStartAlpha(100)
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetStartSize(30 * self.Scale)
			obj_Particle:SetEndSize(80 * self.Scale)
			obj_Particle:SetRoll(mathRand(150,360))
			obj_Particle:SetRollDelta(mathRand(-1,1))
			obj_Particle:SetAirResistance(250)
			obj_Particle:SetGravity(Vector(mathRand(-200,200),mathRand(-200,200),mathRand(10,100)))
	...
	for i = 0,25 * self.Scale do
		...
		local obj_Particle = self.eParticleEmitter:Add("effects/fleck_cement" .. mathrandom(2),self.Pos + self.DirVec)

		if obj_Particle then
			obj_Particle:SetVelocity((self.DirVec * 700 * self.Scale) + (VectorRand():GetNormalized() * 1000 * self.Scale))
			obj_Particle:SetDieTime(mathrandom(0.3,0.5) * self.Scale)
			obj_Particle:SetStartAlpha(255)
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetStartSize(mathrandom(4,7) * self.Scale)
			obj_Particle:SetRoll(mathRand(0,360))
			obj_Particle:SetRollDelta(mathRand(-5,5))
			obj_Particle:SetAirResistance(10)
			obj_Particle:SetColor(53,50,45)
			obj_Particle:SetGravity(vCached1)
			obj_Particle:SetCollide(true)
			obj_Particle:SetBounce(0.8)
		end
	end

	for i = 0,100 * self.Scale do

		local obj_Particle = self.eParticleEmitter:Add("effects/yellowflare",self.Pos + self.DirVec)

		if obj_Particle then
			obj_Particle:SetVelocity(VectorRand():GetNormalized() * mathrandom(400,1000) * self.Scale)
			obj_Particle:SetDieTime(mathrandom(0.5,4))
			obj_Particle:SetStartAlpha(255)
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetStartSize(5)
			obj_Particle:SetEndSize(10)
	...
	for i = 0,Density do
		...
		if obj_Particle then
			obj_Particle:SetVelocity(aAng:Up() * mathRand(50,700 * self.Scale))
...
function EFFECT:Metal()
	...
	for i = 1,30 * self.Scale do
		...
		if obj_Particle then
			obj_Particle:SetVelocity(self.DirVec * mathrandom(100,400) * self.Scale + ((VectorRand():GetNormalized() * 400) * self.Scale))
			obj_Particle:SetDieTime(mathRand(0.5,2) * self.Scale)
			obj_Particle:SetStartAlpha(150)
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetStartSize(30 * self.Scale)
			obj_Particle:SetEndSize(80 * self.Scale)
			obj_Particle:SetRoll(mathRand(150,360))
	...
	for i = 0,100 * self.Scale do
		...
		if obj_Particle then
			obj_Particle:SetVelocity(VectorRand():GetNormalized() * mathrandom(400,1000) * self.Scale)
			obj_Particle:SetDieTime(mathrandom(0.5,3))
			obj_Particle:SetStartAlpha(mathRand(120,150))
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetStartSize(5)
			obj_Particle:SetEndSize(10)
			...
			obj_Particle:SetAirResistance(200)
			obj_Particle:SetColor(255,255,255)
			obj_Particle:SetGravity(VectorRand() * 20)
		end
	end
	...
	for i = 0,10 * self.Scale do
		...
		if obj_Particle then
			...
			obj_Particle:SetRollDelta(mathRand(-5,5))
			obj_Particle:SetAirResistance(100)
			obj_Particle:SetGravity(vCached3)
		end
	end
end
...
function EFFECT:Wood()
	...
	for i = 0,100 * self.Scale do
		...
		if obj_Particle then
			obj_Particle:SetVelocity(VectorRand():GetNormalized() * mathrandom(400,1300) * self.Scale)
			obj_Particle:SetDieTime(mathrandom(0.5,3))
			obj_Particle:SetStartAlpha(mathRand(120,150))
			obj_Particle:SetEndAlpha(0)
			obj_Particle:SetStartSize(5)

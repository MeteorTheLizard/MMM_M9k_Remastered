...
if SERVER then
	...
	function ENT:Initialize()
		...
		self:SetModel("models/items/ammocrates/crateprox.mdl")
...
if CLIENT then
	...
	function ENT:Draw()
		...
		cam.Start3D2D(self:GetPos() + (self:GetUp() * 8) + (self:GetRight() * 6) + (self:GetForward() * 17),FixAngles,0.16)
